...
function FormGroupList({
    ...
    fields.length > 0 ? (
      <div className={styles.formContainerItemList}>
        <div>
          ...
          <label htmlFor="qtdItem" id="qtdItem" className={styles.formLabel}>
            Qtd
          </label>
          <label
            htmlFor="precoItem"
  ...
  return (
    <fieldset className={`${styles.formFieldset} ${styles.formFieldsetMargin}`}>
      <legend className={styles.formSubtitleVariant}>Item Da Lista</legend>
      {useMatchMedia({
        mobileContent: contentMobile,
        desktopContent: contentDesktop,
